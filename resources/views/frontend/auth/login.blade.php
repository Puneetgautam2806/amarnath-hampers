...
<div class="site-breadcrumb-wrap" style="background: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url('{{ asset('frontend/assets/img/banner/big-banner.jpg') }}') no-repeat center center; background-size: cover; padding: 100px 0;">
    <div class="container">
        <div class="site-breadcrumb-content text-center text-white">
            <h2 class="breadcrumb-title text-white" style="font-size: 3rem; font-weight: 800; letter-spacing: 1px; margin-bottom: 10px; text-shadow: 0 2px 4px rgba(0,0,0,0.3);">Login</h2>
            <ul class="breadcrumb-menu d-flex justify-content-center gap-3 list-unstyled" style="font-size: 1.1rem; font-weight: 500;">
                ...
                <li class="active text-pink" style="color: #ff7c8b !important;">Login</li>
            </ul>
        </div>
    </div>
</div>
                ...
                <div class="auth-card bg-white">
                    <div class="auth-card-body p-5">
                        ...
                        <form action="{{ route('customer.login.submit') }}" method="POST">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="input-group auth-input-group">
                                    ...
                                    <input type="password" name="password" class="form-control custom-input with-icon" placeholder="Enter your password" required>
                                </div>
                            </div>
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-5">
                                <div class="custom-control custom-checkbox">
                                    ...
                                    <label class="custom-control-label text-muted" for="remember" style="padding-top: 2px;">Remember me</label>
                                </div>
                                <a href="#" class="text-pink font-weight-bold" style="font-size: 0.9rem; transition: all 0.3s;">Forgot Password?</a>
                            </div>
                        ...
                        <div class="auth-footer text-center mt-5 pt-4 border-top">
                            <p class="text-muted mb-0">Don't have an account? <a href="{{ route('customer.register') }}" class="font-weight-bold text-dark ml-1 auth-link" style="border-bottom: 2px solid #ff7c8b; padding-bottom: 2px;">Register Now</a></p>
                        </div>
                    </div>
                </div>
            </div>
