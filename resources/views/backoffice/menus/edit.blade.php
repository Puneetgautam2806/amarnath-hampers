            ...
            <div class="col-xl-8 col-lg-7">
                <div class="card mb-6">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h4 class="mb-0">Edit Menu: {{ $menu->menu_name }}</h4>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" class="form-control" id="path" name="path" value="{{ old('path', $menu->path) }}" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="d-flex gap-4 mt-2">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="is_parent" id="is_parent_1" value="1" {{ old('is_parent', (string)$menu->is_parent) === '1' ? 'checked' : '' }}>
                                        <label class="form-check-label" for="is_parent_1">Parent Menu</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="is_parent" id="is_parent_2" value="2" {{ old('is_parent', (string)$menu->is_parent) === '2' ? 'checked' : '' }}>
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <select class="form-select" id="parent_id" name="parent_id">
                                        ...
                                        @foreach ($parentMenus as $parentMenu)
                                            <option value="{{ $parentMenu->id }}" {{ (string)old('parent_id', (string)$menu->parent_id) === (string)$parentMenu->id ? 'selected' : '' }}>
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="number" min="1" class="form-control" id="orders" name="orders" value="{{ old('orders', $menu->orders) }}" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="d-flex gap-4 mt-2">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="status" id="status_1" value="1" {{ old('status', (string)$menu->status) === '1' ? 'checked' : '' }}>
                                        <label class="form-check-label" for="status_1">Active</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="status" id="status_2" value="2" {{ old('status', (string)$menu->status) === '2' ? 'checked' : '' }}>
                        ...
                        @php($menuPermissions = old('permissions', explode(',', (string) $menu->permissions)))
                        <div class="mb-6">
                            <label class="form-label d-block mb-2">Check All Allowed Roles</label>
                            <div class="d-flex gap-4 mt-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="role_admin" name="permissions[]" value="admin" {{ in_array('admin', $menuPermissions, true) ? 'checked' : '' }}>
                                    <label class="form-check-label" for="role_admin">Admin</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="role_manager" name="permissions[]" value="manager" {{ in_array('manager', $menuPermissions, true) ? 'checked' : '' }}>
                                    <label class="form-check-label" for="role_manager">Manager</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="role_staff" name="permissions[]" value="staff" {{ in_array('staff', $menuPermissions, true) ? 'checked' : '' }}>
                        ...
                        <div class="pt-4 border-top">
                            ...
                            <a href="{{ route('menus.manage') }}" class="btn btn-outline-secondary">Cancel</a>
                        </div>
                    </div>
                </div>
            </div>
