            ...
            <form action="{{ route('homepage.storeSlider') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card mb-6" style="border-radius: 16px; box-shadow: 0 8px 26px rgba(0,0,0,0.03); border: 1px solid rgba(0,0,0,0.05);">
                    <div class="card-header d-flex justify-content-between align-items-center border-bottom py-4">
                        <div>
                            <h4 class="mb-0 text-dark" style="font-weight: 700;">Add Banner Slide</h4>
                    ...
                    <div class="card-body pt-6">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-6 border-end">
                                ...
                                <div class="p-3 rounded text-center mb-3 d-flex flex-column align-items-center justify-content-center" style="background-color: #f8f9fa; border: 2px dashed #d9dee3; height: 230px;">
                                    <div class="image-preview-container-modal w-100 h-100 d-flex align-items-center justify-content-center" id="image-preview">
                                        <i class="bx bx-cloud-upload text-light mb-2" style="font-size: 3.5rem;"></i>
                                        <span class="text-secondary small fw-bold">Click to Upload Banner Image</span>
                                    </div>
                                    <input class="form-control position-absolute opacity-0" type="file" name="image" id="image" accept="image/*" required onchange="previewFile()" style="height: 200px; width: 330px; cursor: pointer; z-index: 10;">
                                </div>
                                <span class="text-muted small text-center d-block">Automatic resizing will scale and crop your image beautifully.</span>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div>
                                    <button class="btn btn-outline-secondary w-100 fw-bold py-2" type="button" data-bs-toggle="collapse" data-bs-target="#createSliderAdvanced" aria-expanded="false" aria-controls="createSliderAdvanced" style="border-radius: 8px;">
                                        <i class="bx bx-slider-alt me-1"></i> Add Optional details & Buttons
                                    </button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="collapse mt-5" id="createSliderAdvanced">
                            <div class="card card-body p-4 bg-light border" style="border-radius: 12px; border-style: dashed !important; border-width: 1px !important;">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control form-control-sm" id="subtitle" name="subtitle" value="{{ old('subtitle') }}" placeholder="e.g. Exclusive Hamper">
                                    </div>
                                    <div class="col-md-4">
                                        <label class="form-label small fw-bold" for="orders">Display Sort Order</label>
                                        <input type="number" class="form-control form-control-sm" id="orders" name="orders" value="{{ old('orders', 0) }}">
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <select class="form-select form-select-sm" id="status" name="status">
                                            ...
                                            <option value="2" {{ old('status') == '2' ? 'selected' : '' }}>Inactive (Draft)</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea class="form-control form-control-sm" id="description" name="description" rows="2" placeholder="Brief description to capture interest...">{{ old('description') }}</textarea>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 border-end">
                                        ...
                                        <div class="mb-2">
                                            <input type="text" class="form-control form-control-sm" name="btn1_text" value="{{ old('btn1_text') }}" placeholder="Button Text (e.g. Shop Now)">
                                        </div>
                                        <div>
                                            <input type="text" class="form-control form-control-sm" name="btn1_link" value="{{ old('btn1_link') }}" placeholder="Button Link (e.g. /shop)">
                                        </div>
                                    </div>
                                    <!-- Button 2 -->
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-2">
                                            <input type="text" class="form-control form-control-sm" name="btn2_text" value="{{ old('btn2_text') }}" placeholder="Button Text (e.g. Learn More)">
                                        </div>
                                        <div>
                                            <input type="text" class="form-control form-control-sm" name="btn2_link" value="{{ old('btn2_link') }}" placeholder="Button Link (e.g. /about)">
                                        </div>
                                    </div>
                                </div>
