...
@section('title', 'Add New Client Review / Testimonial')

@section('content')
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="mb-0 text-dark fw-bold">Add Client Testimonial</h4>
            <span class="text-muted small">Showcase customer feedback and star ratings on your homepage</span>
        </div>
                    ...
                    <div class="col-lg-8">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="name" class="form-control" value="{{ old('name') }}" placeholder="e.g. Priya Sharma" required style="border-radius: 8px;">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label text-dark fw-semibold">Client Designation / Location</label>
                                <input type="text" name="designation" class="form-control" value="{{ old('designation', 'Customer, Agra') }}" placeholder="e.g. Wedding Client, Agra or Corporate Buyer" style="border-radius: 8px;">
                            </div>
                        </div>

                        <div class="mb-3">
                            <label class="form-label text-dark fw-semibold">Review / Feedback Quote *</label>
                            <textarea name="review_text" class="form-control" rows="5" placeholder="What did the client say about your hampers, trousseau packing, or service?" required style="border-radius: 8px;">{{ old('review_text') }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="p-3 bg-light rounded-3 mb-3 border">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" name="sort_order" class="form-control" value="{{ old('sort_order', 0) }}" placeholder="0" style="border-radius: 8px;">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="status" class="form-select" required style="border-radius: 8px;">
                                    <option value="1" {{ old('status', 1) == 1 ? 'selected' : '' }}>Active (Visible on Homepage)</option>
                                    <option value="2" {{ old('status') == 2 ? 'selected' : '' }}>Hidden / Inactive</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="p-3 bg-light rounded-3 border">
                            ...
                            <p class="small text-muted mb-3">Square avatar image (Optional, max 2MB)</p>
